...
def _integrate_shim(
  ...
  _d.xquat = xquat
  _d.nworld = nworld
  mjwarp.integrate(_m, _d)


def _integrate_jax_impl(m: types.Model, d: types.Data):
  output_dims = {
      'act': d.act.shape,
      'act_dot': d.act_dot.shape,
      'actuator_force': d.actuator_force.shape,
...
@jax.custom_batching.custom_vmap
@ffi.marshal_jax_warp_callable
def integrate(m: types.Model, d: types.Data):
  return _integrate_jax_impl(m, d)


@integrate.def_vmap
@ffi.marshal_custom_vmap
def integrate_vmap(unused_axis_size, is_batched, m: types.Model, d: types.Data):
  d = integrate(m, d)
  return d, is_batched[1]
...
def _forward_pos_and_vel_shim(
  ...
  _d.xquat = xquat
  _d.nworld = nworld
  mjwarp.forward_pos_and_vel(_m, _d)


def _forward_pos_and_vel_jax_impl(m: types.Model, d: types.Data):
  output_dims = {
      'act_dot': d.act_dot.shape,
      'actuator_force': d.actuator_force.shape,
      'actuator_length': d.actuator_length.shape,
...
@jax.custom_batching.custom_vmap
@ffi.marshal_jax_warp_callable
def forward_pos_and_vel(m: types.Model, d: types.Data):
  return _forward_pos_and_vel_jax_impl(m, d)


@forward_pos_and_vel.def_vmap
@ffi.marshal_custom_vmap
def forward_pos_and_vel_vmap(unused_axis_size, is_batched, m: types.Model, d: types.Data):
  d = forward_pos_and_vel(m, d)
  return d, is_batched[1]